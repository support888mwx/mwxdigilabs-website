...
(function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    window.location.href = 'mailto:support@mwxdigilabs.com?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body);

    status.textContent = 'Opening your email app… If nothing happens, email us directly at support@mwxdigilabs.com.';
